                ...
                <section class="section__page page">
                    <div class="content">
                        ...
                        <section class="institute__quote" id="institute-quote">
                            <?php
                            $quote_info = carbon_get_post_meta(get_the_ID(), 'crb_quotes_notebook');
                        ...
                        <section class="institute__innovation">
                            <?php
                            $innovation_img = carbon_get_post_meta(get_the_ID(), 'crb_notebook_image');
                            $innovation_content = carbon_get_post_meta(get_the_ID(), 'crb_notebook_content');
                            ?>
                        ...
                        <section class="institute__collaborators">
                            <?php $logos = carbon_get_post_meta(get_the_ID(), 'crb_logos_notebook') ?>
                            <div class="container">
                                <div class="row">
